...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Takes a pre-crafted HTML email, automatically replaces the links with the"
    "desired address, and sends the email")
